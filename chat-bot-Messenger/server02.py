...
def received_message(event):
    ...
    if quick_reply:
        ...
        # skip 0_1, 0_3
        if quick_reply_payload == '0_0':
            page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0_0,
                      metadata="DEVELOPER_DEFINED_METADATA")

        elif quick_reply_payload == '0_2':
            page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0_2,
                      metadata="DEVELOPER_DEFINED_METADATA")
        elif quick_reply_payload == '0_1':
            page.send(sender_id, config.final_answer)
        elif quick_reply_payload == '0_3':
            page.send(sender_id, config.final_answer)
        elif quick_reply_payload == '0_4':
            page.send(sender_id, config.final_answer)

        elif quick_reply_payload == '0_0_0':
            page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0_0_0,
                      metadata="DEVELOPER_DEFINED_METADATA")
        elif quick_reply_payload == '0_0_1':
            page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0_0_1,
                      metadata="DEVELOPER_DEFINED_METADATA")
        elif quick_reply_payload == '0_0_2':
            page.send(sender_id, config.final_answer)

        # skip 0_1, 0_3

        elif quick_reply_payload == '0_2_0':
            page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0_2_0,
                      metadata="DEVELOPER_DEFINED_METADATA")
        elif quick_reply_payload == '0_2_1':
            page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0_2_1,
                      metadata="DEVELOPER_DEFINED_METADATA")
        elif quick_reply_payload == '0_2_2':
            page.send(sender_id, config.final_answer)


        elif quick_reply_payload == '0_0_0_0':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 74, 2))
        elif quick_reply_payload == '0_0_0_1':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 87, 2))
        elif quick_reply_payload == '0_0_0_2':
            page.send(sender_id, config.final_answer)


        elif quick_reply_payload == '0_0_1_0':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 75, 2))
        elif quick_reply_payload == '0_0_1_1':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 76, 2))
        elif quick_reply_payload == '0_0_1_2':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 77, 2))
        elif quick_reply_payload == '0_0_1_3':
            page.send(sender_id, config.final_answer)

        elif quick_reply_payload == '0_2_0_0':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 91, 2))
        elif quick_reply_payload == '0_2_0_1':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 92, 2))
        elif quick_reply_payload == '0_2_0_2':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 95, 2))
        elif quick_reply_payload == '0_2_0_3':
            page.send(sender_id, config.final_answer)

        elif quick_reply_payload == '0_2_1_0':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 103, 2))
        elif quick_reply_payload == '0_2_1_1':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 106, 2))
        elif quick_reply_payload == '0_2_1_2':
            page.send(sender_id, get_article_from_xlsx(config.law_in_enterprise_xlsx, 107, 2))
        elif quick_reply_payload == '0_2_1_3':
            page.send(sender_id, config.final_answer)

        # page.send(sender_id, "Quick reply tapped")
    else:
        page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0,
                  metadata="DEVELOPER_DEFINED_METADATA")
