...
def received_message(event):
    ...
    message_button = message.get("buttons")
    ...
    #
    # else:
    #     page.send(sender_id, "Bạn muốn hỏi về lĩnh vực?", config.quick_replies_level_0, metadata="DEVELOPER_DEFINED_METADATA")
    print "Attach for mess: ", message_attachments
    text_send = "Chao mung ban den voi iLawyer"
    print "Text send: ", text_send
    send_multi_button(sender_id, text_send, config.button_level_0_2_1)
...
def send_multi_button(recipient, text_send, buttons):
    """
    Shortcuts are supported
    page.send(recipient, Template.Buttons("hello", [
        {'type': 'web_url', 'title': 'Open Web URL', 'value': 'https://www.oculus.com/en-us/rift/'},
    ...
    """
    send_button = []
    # send_button.append(Template.ButtonWeb("Open Web URL", "https://www.oculus.com/en-us/rift/"))
    send_button.append(Template.ButtonPostBack("trigger Postback", "DEVELOPED_DEFINED_PAYLOAD"))
    # send_button.append(Template.ButtonPhoneNumber("Call Phone Number", "+16505551234"))

    send_button.append(Template.ButtonPostBack("Tuan", "Nguyen" ) )
    send_button.append(Template.ButtonPostBack("Tuan2", "Nguyen") )
    # send_button.append(Template.ButtonPostBack('Tuan3', 'Nguyen'))

    # send_button.append(Template.ButtonPostBack('Tuan4', 'Nguyen'))
    # send_button.append(Template.ButtonPostBack('Tuan5', 'Nguyen'))
    # send_button.append(Template.ButtonPostBack('Tuan6', 'Nguyen'))

    #     print button['title'], " ", button['payload'], " ", Template.ButtonPostBack(button['title'], button['payload'])
    print "len Send_button: ", len(send_button)
    page.send(recipient, Template.Buttons(text_send, send_button))
