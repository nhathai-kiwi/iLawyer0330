...
public class RDRsegmenter
{
        ...
        throws IOException
    {
        ...
        // System.out.println("Here your String: " + sb.toString().trim() + "Len String: " + (sb.toString().trim()).length());
    ...
    public void segmentRawCorpus(String inFilePath, String outFilePath)
        throws IOException
    {
        BufferedReader buffer = new BufferedReader(
                new InputStreamReader(new FileInputStream(new File(inFilePath)), "UTF-8"));
        ...
        throws IOException
    {
        ...
        segmenter.segmentRawCorpus(args[0], args[1]);
