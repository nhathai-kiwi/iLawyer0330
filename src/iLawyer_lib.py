...
# TODO add description for input xlsx
def gen_feature_table_labels(inp_xlsx, num_rows, id_column_question, id_column_label):
    feature_table = ib.gen_feature_table_from_xlsx(inp_xlsx, num_rows, id_column_question)
